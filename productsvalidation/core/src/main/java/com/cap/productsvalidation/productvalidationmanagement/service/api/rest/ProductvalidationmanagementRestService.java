...
public interface ProductvalidationmanagementRestService {
	 ...
	 *
	 * @param id
	 *            the ID of the {@link ProductValidationEto}
	 ...
	 *            the {@link ProductValidationEto} to be saved
	 ...
	 *
	 * @param id
	 *            ID of the {@link ProductValidationEto} to be deleted
	 */
	@DELETE
	@Path("/productvalidation/{id}/")
	 ...
	 *
	 * @param id
	 *            the ID of the {@link ProductValidationCto}
