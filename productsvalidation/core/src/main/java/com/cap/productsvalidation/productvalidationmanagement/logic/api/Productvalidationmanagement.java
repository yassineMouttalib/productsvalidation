...
public interface Productvalidationmanagement {
	 ...
	 *
	 * @param id
	 *            The id 'id' of the ProductValidation.
	 ...
	 *
	 * @param criteria
	 *            the {@link ProductValidationSearchCriteriaTo}.
	 ...
	 * 'productValidationId'.
	 *
	 * @param productValidationId
	 *            Id of the productValidation to delete
	 ...
	 *            the {@link ProductValidationEto} to create.
	...
	/**
	 * Returns a paginated list of composite ProductValidations matching the search
	 * criteria.
	 *
	 * @param criteria
	 *            the {@link ProductValidationSearchCriteriaTo}.
