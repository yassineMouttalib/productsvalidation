package com.cap.productsvalidation.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cap.productsvalidation.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cap.productsvalidation.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
