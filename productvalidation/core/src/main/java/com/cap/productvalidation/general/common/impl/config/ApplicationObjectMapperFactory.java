package com.cap.productvalidation.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the productvalidation application.
 */
